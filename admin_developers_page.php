...
<body>
    ...
    <?php
        ...
        if($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['input_items_search']))
        {
            ...
            $author_name = $_GET['input_items_search'];
    ...
    <div class="container"><!-- основной контент -->
        ...
        <?php if ($bAdd_author): ?>
            <div class = "head_word">Добавить нового разработчика</div>
        <?php else: ?>
            <div class = "head_word">Изменить данные о разработчике <?= $result['autor_name'] ?></div>
        ...
        <form method="post" id = create_object enctype="multipart/form-data">
            ...
            <div class="form_word">Загрузка аватарки:</div>
            ...
            <div class="form_word a_dev">Название разработчика:</div>
            ...
            <div class="form_word a_dev">Предпросмотр:</div>
