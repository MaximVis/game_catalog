...
<body>
    ...
    <?php
        ...
        if($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['game']))
        {
            ...
            $text_dscrpt = str_replace('<br>', "\n", $result['game_description']);// Замена <br> на символ новой строки \n 
	...
	<div class="container"><!-- основной контент -->
        ...
        <?php if ($bAdd_game): ?>
            <div class="head_word">Добавление новой игры</div>
        <?php else: ?>
            <div class="head_word">Изменить данные о игре <?= $result['game_name'] ?></div>
